    ...
    def create_session(self, order, payment):
        ...
        try:
            ...
            payment_data = {
                ...
                'cus_add1': order.buyer_address or 'N/A',
                'cus_add2': order.buyer_city or 'N/A',
                'cus_city': order.buyer_city or 'N/A',
                'cus_state': order.buyer_city or 'N/A',
                'cus_postcode': order.buyer_postal_code or '1000',
                'cus_country': order.buyer_country or 'Bangladesh',
                'cus_phone': order.buyer_phone or 'N/A',
                'cus_fax': '',
                'ship_name': f"{order.buyer.first_name} {order.buyer.last_name}".strip() or order.buyer.email,
                'ship_add1': order.buyer_address or 'N/A',
                'ship_add2': order.buyer_city or 'N/A',
                'ship_city': order.buyer_city or 'N/A',
                'ship_state': order.buyer_city or 'N/A',
                'ship_postcode': order.buyer_postal_code or '1000',
                'ship_country': order.buyer_country or 'Bangladesh',
